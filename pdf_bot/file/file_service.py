...
class FileService:
    DOCUMENT_EXTENSIONS = frozenset({".doc", ".docx", ".ppt", ".pptx", ".odt"})
    ...
    def __init__(
        ...
        self.document_task_processor = document_task_processor
    ...
    async def check_document(
        ...
        return await self.document_task_processor.ask_task(update, context)
