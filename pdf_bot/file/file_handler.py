...
# Document MIME types for office files
_DOCUMENT_MIME_TYPES = filters.Document.MimeType("application/msword") | filters.Document.MimeType(
            ...
            ConversationHandler(
                entry_points=[
                    ...
                    MessageHandler(
                        ...
                        self.file_service.check_document,
                    ),
                ],
